...
const string strMessageMagic = "SignatureCoin Signed Message:\n";
...
int64_t GetProofOfWorkBonusRewardFactor(CBlockIndex* pindex)
{
	...
	std::string cseed_str = hash.ToString().substr(15,7);
...
bool CBlock::AcceptBlock()
{
    ...
    if (IsProofOfWork() && nPowHeight > LAST_POW_ONLY_BLOCK)
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "SignatureCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "SignatureCoin: keep your signature up to date to receive free coins!";
        CTransaction txNew;
        txNew.nTime = 1405796945;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1405796945;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 2649956;
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0x0c4bd8633c479b4f13b81ebc747227392ae6c64947b0d06f82d28c1cb495cad7"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xdb, 0xef, 0xfb, 0xfd };
